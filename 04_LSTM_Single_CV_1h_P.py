...
seed_train_val = 50
# train_data, val_data = train_test_split(train_val_data, test_size=0.2, random_state=seed_train_val)
...
for train, val in cv.split(train_val_data):
    ...
    # train_data = train_val_data[np.array(train)]
    # val_data = train_val_data[np.array(val)]
...
select_id = int(input("Enter the select_id: "))
