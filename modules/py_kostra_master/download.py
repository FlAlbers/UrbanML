...
url = "https://opendata.dwd.de/climate_environment/CDC/grids_germany/return_periods/precipitation/KOSTRA/KOSTRA_DWD_2020/"
dir = "raw"


def get_raw(dir="raw",type = 'tab'):
    """download kostra raw data from opendata.dwd.de"""
    # for type = 'csv' or 'asc'
    url = f"https://opendata.dwd.de/climate_environment/CDC/grids_germany/return_periods/precipitation/KOSTRA/KOSTRA_DWD_2020/{type}/"
    print(url)
    try:
        os.makedirs(dir)
    except:
